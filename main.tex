...
\begin{itemize}
    \item (bili独占) 致爱 (约2倍速) 02:46-02:56 开门
...
\begin{itemize}
    \item (录制) 爱莉数值 (酌情裁剪) 00:04-00:05 属性界面和武器界面都包括就行
\end{itemize}
...
\begin{itemize}
    ...
    \item (bili独占) 战场 10:22-10:24 (坦克 BOSS) 爱莉打出最后一击后到换镜头前 (出分时的半秒)
\end{itemize}
...
\begin{itemize}
    \item 纯真梦歌预告 00:20-00:28 爱莉捧水晶 到 三人 (不需要三人分别单独演奏的部分)
\end{itemize}
...
\begin{itemize}
    \item 6.0 版本PV 00:04-00:16 爱莉迈步到镜头到天上为止 (加速, 使得和这一段歌(约9s)时长相等)
\end{itemize}
...
\begin{itemize}
    \item (录制) 英桀死亡 00:22, 00:50, 00:57, 01:32, 01:40, 01:50, 02:03 这7个场景, 每个场景取2秒左右的没有字幕的小片段 (每个场景时长一样, 或者时长不一样卡点)
...
\begin{itemize}
    \item 动画短片/跨越 02:02-02:06 白屏之后的火焰到爱莉回首后的白屏之前
\end{itemize}
...
\begin{itemize}
    \item 动画短片/毕业旅行 (适当加速) 04:57-05:07 passing away 之后到这一部分结束 (紫色光大圆球正面出现前)
\end{itemize}
