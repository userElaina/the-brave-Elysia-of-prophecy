...
本视频使用音频流现有的歌曲音频 \textit{/mad/主音频/the.mp4}, 图像流全部使用自己的图像素材, 即 MAD.
...
第一段歌词及之后的第一段 break 伴奏都是欢快为主的素材.
...
\begin{itemize}
    \item (录制) 爱莉数值 (酌情裁剪) 属性界面和武器界面都包括就行
\end{itemize}
...
\begin{itemize}
    \item 动画短片 跨越 01:22-01:26 角色抬头看流星
    \item 动画短片 跨越 02:04-02:08 唱\textit{破}时角色睁眼
\end{itemize}
